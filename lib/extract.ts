...
export const KW = {
  ...
  phishingStrong: { en: ["scam", "phishing", "fraud", "suspicious", "stole", "stolen", "theft", "hacked", "compromised", "taken over", "account hacked", "unauthorized", "unauthorised"], bn: ["প্রতারণা", "সন্দেহজনক", "চুরি", "চুরি করেছে", "হারিয়ে", "হ্যাক", "অ্যাকাউন্ট হ্যাক", "অননুমোদিত"] },
